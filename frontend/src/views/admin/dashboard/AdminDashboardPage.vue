...
const stats = ref({
  totalReservations: {
    value: 1247,
    change: 15.3, // 전월 대비 증감률 (%)
    diff: 166, // 전월 대비 증감 건수
  },
  totalRestaurants: {
    value: 149,
    change: 8.2,
  ...
  totalMembers: {
    value: 5832,
    newThisMonth: 342, // 이번 달 신규 가입자
    change: 12.7,
  },
  monthlyRevenue: {
    value: 24500000,
    change: -3.4, // 전월 대비 감소
    diff: -860000, // 전월 대비 증감 금액
  },
});
...
const generateWeekLabels = () => {
  ...
  for (let i = 7; i >= 0; i--) {
    ...
    const month = weekAgo.getMonth() + 1;
...
const recentActivities = ref([
  ...
  },
  {
    id: 6,
    type: 'cancellation',
    title: '박민수 님의 예약이 취소되었습니다 (환불 처리 완료)',
    time: '3시간 전',
    badge: '예약 취소',
  ...
  },
  {
    id: 7,
    type: 'partner',
    title: '"잠실점"의 메뉴가 업데이트되었습니다 (3개 메뉴 추가)',
    time: '4시간 전',
    badge: '메뉴 변경',
  ...
  },
  {
    id: 8,
    type: 'reservation',
    title: '정다은 님이 "여의도점"에 저녁 예약을 완료했습니다 (85,000원)',
    time: '5시간 전',
    badge: '예약 완료',
    badgeColor: 'bg-purple-100 text-purple-800',
  },
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
      ...
      <main class="flex-1 overflow-y-auto p-8">
        <div class="max-w-7xl mx-auto space-y-8">
          ...
          <!-- Charts Section - 3개 라인 차트 -->
          <div class="grid grid-cols-3 gap-6">
            <!-- 주차별 가입자 추세 -->
            <div class="bg-white rounded-2xl border border-[#e9ecef] p-6">
              <div class="mb-4">
                <h3 class="text-xl font-bold text-[#1e3a5f]">가입자 추세</h3>
                <p class="text-sm text-[#6c757d] mt-1">최근 8주</p>
              </div>
              <div class="h-64">
                <Line :data="weeklySignups" :options="lineChartOptions" />
              </div>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-[#e9ecef] p-6">
              ...
              <div class="h-64">
                <Line :data="weeklyRevenue" :options="lineChartOptions" />
              </div>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-[#e9ecef] p-6">
              ...
              <div class="h-64">
                <Line :data="weeklyReservations" :options="lineChartOptions" />
              </div>
            </div>
          </div>
